...
describe("Tests suite for ensuring correct functionality for cnn datasource.", () => {
    ...
    let assertNewsModel = (news) => {
        ...
        expect(news.paragraphs[0].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[1].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[2].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[3].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[4].subheadingLevel).toBe(-1);
        expect(news.paragraphs[5].content.trim()).toBe("Mosul has been under ISIS control since June 2014.");
        expect(news.paragraphs[5].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[6].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[7].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[9].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[10].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[11].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[12].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[13].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[14].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[15].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[17].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[18].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[19].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[20].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[21].subheadingLevel).toBe(-1);
        expect(news.paragraphs[22].content.trim()).toBe("Only three of the group's members know each other.");
        expect(news.paragraphs[22].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[23].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[24].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[26].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[27].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[28].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[29].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[30].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[32].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[33].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[34].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[35].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[36].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[38].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[39].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[40].subheadingLevel).toBe(-1);
        ...
        expect(news.paragraphs[43].subheadingLevel).toBe(-1);
        expect(news.paragraphs[44].content.trim()).toBe('"We want people to know that we reject ISIS," he said.');
        expect(news.paragraphs[44].subheadingLevel).toBe(-1);
    };
});