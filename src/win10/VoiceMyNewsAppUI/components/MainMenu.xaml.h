...
public:
    ...
    /**
     * \brief This property allows consumer to set / get the frame where menu items can load pages.
     */
    property Frame^ ContentView {
        Frame^ get();
...
public:
    ...
    /**
     * \brief This method handles all navigation events generated by the js part and opens the right app page.
     */
    void WireJsNavigationEvents();
};
